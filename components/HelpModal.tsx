  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Guia Rápido do Bolsão de Ideias">
      <div className="space-y-6 text-gray-700 dark:text-gray-300">
        <div>
          <h3 className="text-xl font-semibold text-brand-dark dark:text-white mb-2">Visão Geral do Portfólio</h3>
          <p>
        ...
        <div className="p-4 bg-gray-50 dark:bg-brand-dark-bg border border-gray-200 dark:border-brand-dark-border rounded-lg">
          <h3 className="font-bold text-brand-dark dark:text-white mb-2">Análise de Clusters</h3>
          <p>
        ...
        <div className="p-4 bg-gray-50 dark:bg-brand-dark-bg border border-gray-200 dark:border-brand-dark-border rounded-lg">
          <h3 className="font-bold text-brand-dark dark:text-white mb-2">Priorização de Ideias</h3>
           <p>
        ...
        <div>
          <h3 className="text-xl font-semibold text-brand-dark dark:text-white mb-2">Buscador de Ideias</h3>
           <p>
