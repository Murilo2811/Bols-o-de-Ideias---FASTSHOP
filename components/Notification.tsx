...
const typeClasses = {
  success: 'bg-gray-800 border-gray-600 text-white dark:bg-gray-200 dark:border-gray-400 dark:text-black',
  error: 'bg-gray-700 border-gray-500 text-white dark:bg-gray-300 dark:border-gray-500 dark:text-black',
  info: 'bg-gray-600 border-gray-400 text-white dark:bg-gray-400 dark:border-gray-600 dark:text-black',
};
